...
exports.network_history = {
  ...
  // max_hours: The maximum # of hours of network history to save (0 = no limit)
  "max_hours": 0
};
...
exports.shared_pages = {
  ...
  "page_header": {
    ...
    "panels": {
      ...
      // usd_price_panel: a collection of settings that pertain to the USD price panel which displays the current USD price
      "usd_price_panel": {
      ...
      // usd_market_cap_panel: a collection of settings that pertain to the USD market cap panel which displays the current USD market cap
      ...
      // spacer_panel_1: a collection of settings that pertain to the first spacer panel which can be used for layout purposes
      "spacer_panel_1": {
        // enabled: Enable/disable the first spacer panel (true/false)
        //          If set to false, the first spacer panel will be completely inaccessible
        "enabled": false,
        // display_order: Determine which order this panel is shown from 1-5
        //                1 = far left panel, 5 = far right panel
        //                The panel will be disabled with a value of 0
      ...
      // spacer_panel_2: a collection of settings that pertain to the second spacer panel which can be used for layout purposes
      "spacer_panel_2": {
        // enabled: Enable/disable the second spacer panel (true/false)
        //          If set to false, the second spacer panel will be completely inaccessible
        "enabled": false,
        // display_order: Determine which order this panel is shown from 1-5
        //                1 = far left panel, 5 = far right panel
        //                The panel will be disabled with a value of 0
      ...
      // spacer_panel_3: a collection of settings that pertain to the third spacer panel which can be used for layout purposes
      "spacer_panel_3": {
        // enabled: Enable/disable the third spacer panel (true/false)
        //          If set to false, the third spacer panel will be completely inaccessible
        "enabled": false,
        // display_order: Determine which order this panel is shown from 1-5
        //                1 = far left panel, 5 = far right panel
        //                The panel will be disabled with a value of 0
    ...
    "network_charts": {
      ...
      "nethash_chart": {
        ...
        "enabled": true,
        // chart_title: The title displayed on the network hashrate chart
        "chart_title": "Hashrate",
        // legend: Show/hide the chart legend (true/false)
        "legend": true,
        // block_line: Show/hide the block line on the chart (true/false)
        "block_line": false,
        // chart_height: The height of the chart in pixels
        "chart_height": 150,
        // full_row: Determine whether the chart takes up a full row (true/false)
        "full_row": false,
        // stretch_to_fit: Determine whether the chart stretches to fit available space (true/false)
      ...
      "difficulty_chart": {
        ...
        "enabled": true,
        // chart_title: The title displayed on the network difficulty chart
        "chart_title": "Difficulty",
        // legend: Show/hide the chart legend (true/false)
        "legend": true,
        // block_line: Show/hide the block line on the chart (true/false)
        "block_line": false,
      ...
      // sync_charts: Determine whether to sync both charts together (true/false)
      "sync_charts": false,
...
exports.index_page = {
  ...
  // show_extracted_by: Determine whether to show the miner/pool that extracted/mined each block (true/false)
...
exports.block_page = {
  ...
  // multi_algorithm: Determine whether the blockchain uses multiple algorithms (true/false)
...
exports.network_page = {
  ...
  //                 Table data is populated via the /ext/getnetworkpeers api
  "addnodes_table": {
    // enabled: Enable/disable the add nodes table (true/false)
    //          If set to false, the add nodes table will be completely inaccessible
    "enabled": true,
    // page_length_options: An array of page length options that determine how many items/records to display in the table at any given time
    "page_length_options": [ 10, 25, 50, 75, 100 ],
    // items_per_page: The default amount of items/records to display in the table at any given time
  ...
  //               Table data is populated via the /ext/getnetworkpeers api
  "onetry_table": {
    // enabled: Enable/disable the one try table (true/false)
    //          If set to false, the one try table will be completely inaccessible
    "enabled": true,
    // page_length_options: An array of page length options that determine how many items/records to display in the table at any given time
    "page_length_options": [ 10, 25, 50, 75, 100 ],
    // items_per_page: The default amount of items/records to display in the table at any given time
...
exports.richlist_page = {
  ...
  "wealth_distribution": {
    ...
    // show_address_count: Show/hide the address count in the wealth distribution section (true/false)
...
exports.markets_page = {
  ...
  //            Supported exchanges: altmarkets, bittrex, bleutrade, crex, dex-trade, freiexchange/freixlite, poloniex, southxchange, txbit, unnamed, yobit
  "exchanges": {
  ...
  // market_price: Determine the source for market price. Valid options: exchange, coingecko
  "market_price": "exchange",
  // coingecko_currency: The currency to use when getting market price from CoinGecko (e.g., usd, btc, eth)
  "coingecko_currency": "usd",
  // coingecko_api_key: Your CoinGecko API key (required for CoinGecko Pro API)
  "coingecko_api_key": ""
};
  ...
  "public_apis": {
    ...
    "ext": {
      ...
      "getlasttxs": {
        ...
        "max_items_per_query": 100,
        // show_extracted_by: Determine whether to include the miner/pool that extracted/mined each block in the API response (true/false)
        "show_extracted_by": false
      },
...
exports.claim_address_page = {
  ...
  // enable_captcha: Enable/disable captcha verification on the claim address page (true/false)
  //                 NOTE: Requires the "captcha" settings to be configured
...
exports.sync = {
  ...
  // batch_size: The number of blocks to process in a single batch during sync
  "batch_size": 100,
  // elastic_stack_size: The maximum size of the elastic stack used during sync
  "elastic_stack_size": 1000,
  // wait_for_bulk_database_save: Determine whether to wait for bulk database saves to complete before continuing (true/false)
  "wait_for_bulk_database_save": false,
  // rate_limit: The rate limit for sync operations in milliseconds (0 = no limit)
  "rate_limit": 0,
...
// captcha: a collection of settings that pertain to captcha verification
exports.captcha = {
  // provider: The captcha provider to use. Valid options: recaptcha, hcaptcha
  "provider": "recaptcha",
  // site_key: Your captcha site key
  "site_key": "",
  // secret_key: Your captcha secret key
  "secret_key": ""
};

// default_coingecko_ids: Default CoinGecko IDs for common cryptocurrencies used for USD price lookups
exports.default_coingecko_ids = {
  // BTC: Bitcoin CoinGecko ID
  "BTC": "bitcoin",
  // ETH: Ethereum CoinGecko ID
  "ETH": "ethereum",
  // LTC: Litecoin CoinGecko ID
  "LTC": "litecoin",
  // DOGE: Dogecoin CoinGecko ID
  "DOGE": "dogecoin",
  // USDT: Tether CoinGecko ID
  "USDT": "tether"
};

// plugins: a collection of settings that pertain to the plugin system
exports.plugins = {
  // enabled: Enable/disable the plugin system (true/false)
  "enabled": false,
  // plugins_directory: The directory where plugins are stored
  "plugins_directory": "./plugins"
};

// benchmark: a collection of settings that pertain to benchmarking
exports.benchmark = {
  // enabled: Enable/disable benchmarking (true/false)
  "enabled": false,
  // log_to_console: Determine whether to log benchmark results to console (true/false)
  "log_to_console": false,
  // log_to_file: Determine whether to log benchmark results to file (true/false)
  "log_to_file": false,
  // file_path: The path to the benchmark log file
  "file_path": "./tmp/benchmark.log"
};
